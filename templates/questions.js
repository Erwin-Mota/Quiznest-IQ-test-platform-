...
const questions = [
    // Question 1: Raven's Progressive Matrices Style - 3x3 Grid Pattern
    {
        id: 1,
        ...
        question: `
            <div class="pattern-question">
                ...
                <p style="text-align: center; margin-top: 1rem; font-weight: 600;">Which pattern completes the sequence?</p>
            </div>
        `,
        options: [
            '<div class="matrix-shape small-circle"></div>',
        ...
        correct: 1,
        explanation: "The pattern shows shapes alternating between small and large sizes, with the last shape being large, so the missing piece should be a large shape."
    },

    // Question 2: 3x3 Matrix Pattern - Corner Logic
    {
        id: 2,
        category: "Pattern Recognition",
        type: "visual",
        question: `
            <div class="pattern-question">
                <div class="matrix-grid">
                    <div class="matrix-cell"><div class="matrix-shape small-circle"></div></div>
                    <div class="matrix-cell"><div class="matrix-shape large-square"></div></div>
                    <div class="matrix-cell"><div class="matrix-shape small-triangle"></div></div>
                    <div class="matrix-cell"><div class="matrix-shape large-diamond"></div></div>
                    <div class="matrix-cell"><div class="matrix-shape small-circle"></div></div>
                    <div class="matrix-cell"><div class="matrix-shape large-square"></div></div>
                    <div class="matrix-cell"><div class="matrix-shape small-triangle"></div></div>
                    <div class="matrix-cell"><div class="matrix-shape large-diamond"></div></div>
                ...
                <p style="text-align: center; margin-top: 1rem; font-weight: 600;">Which pattern completes the matrix?</p>
            </div>
        `,
        options: [
            '<div class="matrix-shape small-circle"></div>',
        ...
        correct: 0,
        explanation: "The pattern shows shapes in a 3x3 grid with diagonal symmetry; the missing corner should be small-circle."
    },
